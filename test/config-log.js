...
describe('config: log.messages/log.theme', function() {
  ...
  // This test will become effective after applying the PR js-liftoff#95
  it.skip('Should configure log message and theme of require flag', function(done) {
    runner({ verbose: true })
      .basedir(fixturesDir)
  ...
  // This test will become effective after applying the PR js-liftoff#95
  it.skip('Should configure log message and theme of require error', function(done) {
    runner({ verbose: false })
      .basedir(fixturesDir)
  ...
  // This test will become effective after applying the PR js-liftoff#95
  it.skip('Should configure log message and theme of node flag', function(done) {
    runner({ verbose: false })
      .basedir(fixturesDir)
      .gulp('--harmony')
      .run(cb);
    ...
    function cb(err, stdout, stderr) {
      ...
      stdout = eraseTime(stdout);
      expect(headLines(stdout, 1)).toEqual(
        'GULP HAS BEEN RESPAWNDED BY --harmony'
      );
      done(err);
    }
  });
